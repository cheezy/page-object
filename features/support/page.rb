class Page
  ...
  tr(:tr_css, :css => '.tr_class')
  tr(:tr_index, :index => 1)
  tr(:tr_text, :text => 'Data1 Data2')
  tr(:tr_xpath, :xpath => '//table//tbody//tr[1]')
  tr(:tr_class_index, :class => "tr_class", :index => 0)
  tr(:tr_name_index, :name => "tr_name", :index => 0)
