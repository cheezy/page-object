...
describe PageObject::Link do
  
  describe "when mapping how to find an element" do
    it "should map watir types to same" do
      [:class, :href, :id, :index, :name, :text, :xpath].each do |t|
        identifier = PageObject::Link.watir_identifier_for t => 'value'
    ...
    it "should map selenium types to same" do
      [:class, :id, :link, :link_text, :name, :xpath].each do |t|
        key, value = PageObject::Link.selenium_identifier_for t => 'value'
        key.should == t
      end
    end
    
    it "should map watir types to selenium" do
      key, value = PageObject::Link.selenium_identifier_for :text => 'value'
